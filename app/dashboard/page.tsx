...
export default async function DashboardPage() {
  try {
    ...
    if (!userId) {
      console.log('DashboardPage: No userId found, redirecting to home');
      redirect("/");
    }

    console.log('DashboardPage: Fetching/Creating user');
    const user = await getOrCreateUser();
    if (!user) {
      console.log('DashboardPage: User object is null, redirecting to home');
      redirect("/");
    }

    console.log(`DashboardPage: Fetching portfolio for userId: ${user.id}`);
